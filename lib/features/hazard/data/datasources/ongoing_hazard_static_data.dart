...
class OngoingHazardStaticData {
  OngoingHazardStaticData._();

  static List<OngoingHazardEntity> seed({String lang = 'bn'}) {
    final now = DateTime.now().millisecondsSinceEpoch;
    final isBangla = lang == 'bn';
    T pick<T>(T bn, T en) => isBangla ? bn : en;

    OngoingHazardEntity item(String id, String titleBn, String titleEn) => OngoingHazardEntity(
          id: id,
